...
const displayController = (function () {
  ...
  submit1.addEventListener("click", (e) =>
    _setPlayerName(e, input1.value, player1Form, player1, display1, score1)
  );
  submit2.addEventListener("click", (e) =>
    _setPlayerName(e, input2.value, player2Form, player2, display2, score2)
  );
...
const gameBoard = (function () {
  ...
  function _gameFlow() {
    displayController.gameCells.forEach((cell) =>
      cell.addEventListener("click", (e) => _placeGamePiece(e))
    );
  }
